#Test output for global API; prints summary data for global crypto market
import requests
import json
...
print('The global market cap of all cryptos is ' + global_cap_string + ' and the 24h global volume is ' + global_volume_string + '.')
